...
which makes it more difficult to join Synergy data with Clarity data for example.
 __Core CDM__ uses
  'PAT_ENC_CSN_ID' as the primary key for nearly all tables.  

* __Data delays__: 
While EpicClarity is updated daily for the previous 24hrs, 
the other main databases have a delayed refresh cadence 
...
as well as more timely projects based on Epic documentation and clinical data. 

* __Non-standard naming conventions__: 
Tables in EpicClarity, Synergy, Callisto, Caboodle, CPS datamarts 
and other databases 
